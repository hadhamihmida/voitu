    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('/registre/client') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="numero_telephone" class="col-md-4 col-form-label text-md-end">{{ __('Numero Telephone') }}</label>

                            <div class="col-md-6">
                                <input id="numero_telephone" type="text" class="form-control @error('numero_telephone') is-invalid @enderror" name="numero_telephone" value="{{ old('numero_telephone') }}"  >
